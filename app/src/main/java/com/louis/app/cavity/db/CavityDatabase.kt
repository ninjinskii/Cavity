        ...
        private val callback = object : Callback() {
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                thread {
                    ...
                    with(wineDao!!) {
                        insertWine(Wine(1, "Immelé", "Gerwurztraminer", 0, "Saint Nicolas", 1, 0, ""))
                        insertWine(Wine(2, "Immelé", "Gerwurztraminer", 0, "", 1, 1, ""))
                        insertWine(Wine(3, "Immelé", "Pinot gris", 0, "Vendanges Tardives", 1, 0, ""))
                        ...
                        insertWine(Wine(8, "Domaine Delience Frères", "Clos de la Marole", 1, "", 2, 1, ""))
                        insertWine(Wine(9, "Domaine Masse Fabrice", "La Brûlée", 1, "Grand Cru Classé", 2, 0, ""))
                        ...
                        insertWine(Wine(15, "Domaine Les Creisses", "Herault", 1, "Le Bastion", 4, 0, ""))
                        insertWine(Wine(16, "Domaine Des Fusils", "Herault", 1, "", 4, 1, ""))

                        insertWine(Wine(17, "Mas Amiel pur schiste", "Côte du Roussillon", 1, "", 9, 0, ""))
                        insertWine(Wine(18, "Domaine Bastide Miraflor", "Côte du Roussillon", 1, "", 9, 0, ""))
                        ...
                        insertWine(Wine(25, "Château Fleur Haut Gaussens", "Bordeau supérieur", 1, "", 8, 0, ""))
                        insertWine(Wine(26, "Les tuileries de Lansac", "Côte de Bourg", 1, "", 8, 0, ""))
                        ...
                        insertWine(Wine(30, "Primitivo Rin Forzato Giordano", "Les Pouilles", 1, "Amaretto passi", 7, 0, ""))
                        insertWine(Wine(31, "Barolo le Terre", "Toscane", 1, "Amaretto passi", 7, 1, ""))
                        insertWine(Wine(32, "Chianti classico La Palaia", "Toscane", 1, "", 7, 0, ""))
                        insertWine(Wine(33, "Ripasso Superieur Zeni", "Venetie", 1, "", 7, 0, ""))
                    }

                    with(bottleDao!!) {
                        insertBottle(Bottle(0, 1, 2014, 2024, 0, 1, 14, "", "Vin succulent", "Leclerc Lure", -1, "Notes amères", "",))
                        insertBottle(Bottle(0, 1, 2013, 2023, 1, 2, 14, "", "Elu super vin dans un certain concours", "", -1, "Doux", "",))
                        insertBottle(Bottle(0, 1, 2016, 2019, 0, 1, 25, "", "", "", -1, "Doux", "",))
                        ...
                        insertBottle(Bottle(0, 5, 2017, 2040, 0, 15, 16, "", "", "Cavavin", -1, "", "",))
                        ...
                        insertBottle(Bottle(0, 10, 2020, 2030, 0, 1, 16, "", "", "Foire aux vins Lure", -1, "", "",))
                        insertBottle(Bottle(0, 10, 2019, 2031, 1, 1, 18, "", "", "Foire aux vins Lure", -1, "", "",))
                        ...
                        insertBottle(Bottle(0, 23, 2015, 2019, 1, 1, 1000, "", "", "Intermarché Belfor", -1, "", "",))
                        insertBottle(Bottle(0, 23, 2014, 2016, 1, 1, 20, "", "", "Un autre Intermarché", -1, "", "",))
                        ...
                        insertBottle(Bottle(0, 30, 2011, 2019, 0, 1, 30, "", "Aîe", "", -1, "Paille", "",))
                        ...
                        insertBottle(Bottle(0, 33, 2015, 2022, 0, 1, 7, "", "", "", -1, "Piquette", "",))
                    }
                }
            }
        }
