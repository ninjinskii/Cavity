            ...
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                GlobalScope.launch(IO) {
                    ...
                    repeat(10) {
                        ...
                        historyDao.insertEntry(
                            HistoryEntry(0, 1612209671968L, 1, 0, "Aurait pu vieillir", 0)
                        )
                        ...
                        historyDao.insertEntry(
                            HistoryEntry(0, 1612409671968L, 3, 0, "Déguelasse", 0)
                        )
                        ...
                        historyDao.insertEntry(
                            HistoryEntry(0, 1612609671968L, 1, 1, "Dégustation", 4)
                        )

                        historyDao.insertEntry(
                            HistoryEntry(0, 1612709671968L, 5, 0, "Plutot bon", 0)
                        )
                    }
